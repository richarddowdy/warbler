...
# g object disappears, needs to be reset, credentials are set to G and made
...
def handle_likes_delete(user_id, msg_id):
    """Unfill star, delete liked message from user's likes. Redirect
       to user's likes page.
    """
